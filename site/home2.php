...
<nav class="navbar navbar-default navbar-fixed-top">
  ...
  <strong style="font-size:1.5em">Moon Meet</strong>
    ...
    <form class="navbar-form navbar-left" method="GET" action="search">
      <div class="form-group">
        <input type="text" class="form-control search-bar-navbar" name="q" placeholder="Search">
      </div>
...
<script>
function check_text() {
		if(document.getElementsById("chat_message").value=="") { 
			   document.getElementByClassName('send_chat').disabled = true; 
		   } else { 
			   document.getElementByClassName('send_chat').disabled = false;
		   }
     }
     
     function btnActivation(){

if(!document.getElementById('chat_message').value.length){
    ...
    <ul style="float:none" class="nav navbar-nav ">
      ...
      <li><a href="developers"><strong><i style="font-size:20px" class="fa fa-code"></i> Developers</strong></a></li>
...
<div class="alert alert-danger" id="state">
    <center>
    <h1 style="color: #193566#193566;"><strong><i class="fa fa-exclamation-triangle"></i> Oups ! <i class="fa fa-exclamation-triangle"></i></strong></h1>
...
<div id="mySidenav" class="sidenav">
  ...
  <!-- <a class="user-under-mmet" style="margin-left: 25px; margin-top:-5px;" href="balance"><img style="width:38px;margin-top:-5px" src="images/moneybag" alt="" srcset=""></i> Balance: <?php echo $balance; ?></a>-->
  <!--<a class="user-under-mmet" style="margin-left: 32px; margin-top:-5px;" href="balance"><i class="fa fa-star"></i> Popularity: <?php echo $popularity; ?></a>  <div style="background-color: white; height:5px;">-->
  ...
  <button id="changetheme" onclick="changeTheme();" class="btn btn-danger btn-block btn-lg"><strong><i class="fa fa-exchange"></i> Change Theme</strong></button>
  <style>
  .changeBackground {
    ...
    <div class="modal-dialog ">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><?php echo $_SESSION['username']; ?>'s Profile Image</h4>
        </div>
        <div class="modal-body">
...
<strong style="font-size:1.2em"><i style="font-size:24px;margin-right:3px" class="fa">&#xf10b;</i>  Moon Meet Mobile App</strong>
  ...
  <h4 style="text-align:center;"><strong>You can also use Moon Meet on your phone by downloading the Mobile Application</strong></h4>
  <img class="img img-thumbnail" style="width:100%;" src="images/screenshots/1" alt="" srcset="">
  <a href="download" target="_blank" class="btn btn-success btn-block btn-lg"><i class="fa fa-download"></i><strong> Download</strong></a>
   </div>
  </div>
<!--<iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fmoonmeet.inc%2F&tabs=timeline&width=340&height=500&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="340" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>-->
    ...
    <button style="margin-top:-6px; margin-right: 15px" class="btn logout-navbar btn-primary" type="submit" name="logout"><strong>Logout</strong></button>
    </form>
   </div>
     ...
     <strong><?php echo $_SESSION['username']; ?></strong>, how are you today ?
        ...
        <div class="panel panel-primary">
         <div class="panel-heading"><i class="fa fa-comment"></i> <strong>Chats and Discussions</strong></div>
           <div class="panel-body">
<form class="form-content" method="POST" action="search">
      <div class="col-sm-9">
        <input  type="text" class="form-control search-bar-navbar" name="q" placeholder="Search" required>
        </div>
      <div class="col-sm-3">
      <button type="submit" align="center" name="search" class="btn btn-primary"><i class="fa fa-search"></i></button>
      </div>
  ...
  <path d="M23.6,0c-3.4,0-6.3,2.7-7.6,5.6C14.7,2.7,11.8,0,8.4,0C3.8,0,0,3.8,0,8.4c0,9.4,9.5,11.9,16,21.2
	c6.1-9.3,16-12.1,16-21.2C32,3.8,28.2,0,23.6,0z"/>
      ...
      <!----- loading ------>
      <section style="overflow-x:hidden" class="loading-overlay">
      <center>
