...
<head>
    ...
    <title>Rules of Moon Meet</title>
</head>
<body>                  <script>document.addEventListener('contextmenu', event => event.preventDefault());
</script>
<div class="container">
        <div class="col-sm-12">
        <center><img style="width:250px;margin-top:-60px" src="images/logo.png" alt="" srcset="">
        <h1><strong>Moon Meet Rules</strong></h1>
