...
include("database_connection2.php");
  ...
  echo "<div id='post' class='alert alert-info'><h4 style='font-family:sans-serif; font-size:23px'>
  ...
  <br>
  <button type='submit' class='btn btn-primary btn-block btn-lg'><i class='fa fa-thumbs-up'></i> Like</button>
  </div>
  ";
}
 ?>