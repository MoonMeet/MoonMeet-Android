...
public final class NtcnumDialogFragmentBinding implements ViewBinding {
  @NonNull
  ...
  private NtcnumDialogFragmentBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout bg,
      @NonNull LinearLayout card, @NonNull CardView cardview, @NonNull TextView continueTxt,
      @NonNull LinearLayout lastLinear, @NonNull LinearLayout main,
      @NonNull LinearLayout middleLinear, @NonNull TextView moonmeet, @NonNull TextView proccesTxt,
      @NonNull LinearLayout space, @NonNull LinearLayout topLinear) {
  ...
  @NonNull
  public static NtcnumDialogFragmentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NtcnumDialogFragmentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.ntcnum_dialog_fragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NtcnumDialogFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NtcnumDialogFragmentBinding((LinearLayout) rootView, bg, card, cardview,
          continueTxt, lastLinear, main, middleLinear, moonmeet, proccesTxt, space, topLinear);
    }
