...
public final class CodeDialogFragmentBinding implements ViewBinding {
  @NonNull
  ...
  private CodeDialogFragmentBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout bg,
  ...
  @NonNull
  public static CodeDialogFragmentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static CodeDialogFragmentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.code_dialog_fragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static CodeDialogFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CodeDialogFragmentBinding((LinearLayout) rootView, bg, card, cardview, continueTxt,
          lastLinear, main, middleLinear, moonmeet, proccesTxt, space, topLinear);
    }
