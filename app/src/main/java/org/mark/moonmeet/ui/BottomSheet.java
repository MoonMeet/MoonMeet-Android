...
import org.mark.moonmeet.components.AnimationProperties;
...
public class BottomSheet extends Dialog {
    ...
    protected String behindKeyboardColorKey = "#eeeeee";
    ...
    protected class ContainerView extends FrameLayout implements NestedScrollingParent {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (rect.bottom != 0 && rect.top != 0) {
                int usableViewHeight = rootView.getHeight() - (rect.top != 0 ? 45 : 0) - AndroidUtilities.getViewInset(rootView);
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        public BottomSheetCell(Context context, int type) {
           ...
           setBackgroundDrawable(Theme.getSelectorDrawable(false));
            ...
            imageView.setColorFilter(new PorterDuffColorFilter(Theme.getColor("colorPrimaryText")  , PorterDuff.Mode.MULTIPLY));
            ...
            if (type == 0) {
                textView.setTextColor(Theme.getColor("colorPrimaryText"));
