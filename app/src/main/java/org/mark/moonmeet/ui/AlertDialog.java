...
import org.mark.moonmeet.components.LineProgressView;
import org.mark.moonmeet.components.RLottieImageView;
import org.mark.moonmeet.components.RadialProgressView;
import org.mark.moonmeet.messenger.FileLog;
import org.mark.moonmeet.messenger.LocaleController;
...
public class AlertDialog extends Dialog implements Drawable.Callback {
    ...
    public static class AlertDialogCell extends FrameLayout {
        ...
        public void setTextAndIconUri(CharSequence text, Uri uri){
            textView.setText(text);
            if(uri != null){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (title != null) {
            ...
            titleTextView.setTypeface(AndroidUtilities.getTypeface("fonts/opensans_regular.ttf"));
        ...
        if (progressViewStyle == 0) {
            ...
            AndroidUtilities.setScrollViewEdgeEffectColor(contentScrollView, 0xdadada);
        ...
        if (progressViewStyle == 1) {
            ...
            progressView.setProgressColor(0x193566);
            ...
            lineProgressView.setProgressColor(0x193566);
            lineProgressView.setBackColor(0x193566);
            ...
            lineProgressViewPercent.setTypeface(AndroidUtilities.getTypeface("fonts/opensans_regualr.ttf"));
            ...
            progressViewContainer = new FrameLayout(getContext());
            progressViewContainer.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.dp(18), 0xffffff));
        ...
        if (items != null) {
            ...
            for (int a = 0; a < items.length; a++) {
                ...
                if(itemIcons == null){
                    ...
                    cell.setTextAndIconUri(items[a], itemUris == null ? null : itemUris[a]);
                }else{
...
//                textView.setSingleLine(true); //TODO
    ...
    private void showCancelAlert() {
        ...
        builder.setTitle("Sketchub");
        builder.setMessage("Stop loading?");
    ...
    public static class Builder {
        ...
        public Builder setItems(CharSequence[] items, Uri[] uris, final OnClickListener listener){
            alertDialog.items = items;
            alertDialog.itemUris = uris;
