...
public class AdjustPanLayoutHelper {
    ...
    private void animateHeight(int previousHeight, int contentHeight, final boolean isKeyboardVisible) {
        if (animator != null) {
            animator.cancel();
        }
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                AdjustPanLayoutHelper.this.onPanTranslationUpdate(-y, v, isKeyboardVisible);
            }
        });
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                NotificationCenter.getInstance().onAnimationFinish(notificationsIndex);
                animator = null;
        ...
        notificationsIndex = NotificationCenter.getInstance().setAnimationInProgress(notificationsIndex, null);
        animator.start();
    }
    ...
    public void onAttach() {
        /*if (false){//!SharedConfig.smoothKeyboard) {
            return;
        }*/
        onDetach();
