...
public class TermsandprivacyActivity extends AppCompatActivity /* implements NotificationCenter.NotificationCenterDelegate */{
    ...
    private void initializeLogic() {
        ...
        menu.addItem(64, getParentActivity().getResources().getDrawable(R.drawable.ghost));
        actionBar.setItemsBackgroundColor(getParentActivity().getResources().getColor(R.color.MoonRippleColor));
        ...
        TooltipCompat.setTooltipText(imageview1, "Back");
    }
