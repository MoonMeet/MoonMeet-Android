...
public class UserprofileActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		...
		shared_rv.setAdapter(new Shared_rvAdapter(SharedMedia));
		GridLayoutManager mGridLayoutManager = new GridLayoutManager(UserprofileActivity.this,3);
	...
	public void _libsben_animation (final View _view, final String _libsben, final Intent _libsben_intent) {
		...
		android.app.ActivityOptions optionsCompat = android.app.ActivityOptions.makeSceneTransitionAnimation(UserprofileActivity.this, _view, _libsben);
	...
	public void _Popup () {
		View popupView = getLayoutInflater().inflate(R.layout.ptools, null);
		...
		lin1.setOnClickListener(new OnClickListener() { public void onClick(View view) {
				((ClipboardManager) getSystemService(getApplicationContext().CLIPBOARD_SERVICE)).setPrimaryClip(ClipData.newPlainText("clipboard", User_Firstname.concat(" ".concat(User_Lastname))));
				popup.dismiss();
			} });
		
		lin2.setOnClickListener(new OnClickListener() { public void onClick(View view) {
				((ClipboardManager) getSystemService(getApplicationContext().CLIPBOARD_SERVICE)).setPrimaryClip(ClipData.newPlainText("clipboard", User_Username));
				popup.dismiss();
			} });
		
		lin3.setOnClickListener(new OnClickListener() { public void onClick(View view) {
				((ClipboardManager) getSystemService(getApplicationContext().CLIPBOARD_SERVICE)).setPrimaryClip(ClipData.newPlainText("clipboard", User_Bio));
				popup.dismiss();
			} });
