...
public class SetupActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		width_linear = (LinearLayout) findViewById(R.id.width_linear);
		bottom_linear = (LinearLayout) findViewById(R.id.bottom_linear);
		image_holder = (LinearLayout) findViewById(R.id.image_holder);
		all_edittext_holder = (LinearLayout) findViewById(R.id.all_edittext_holder);
		avatar_holder = (LinearLayout) findViewById(R.id.avatar_holder);
		...
		divider_first = (LinearLayout) findViewById(R.id.divider_first);
		lastname_edittext = (EditText) findViewById(R.id.lastname_edittext);
		divider_last = (LinearLayout) findViewById(R.id.divider_last);
		imageview2 = (ImageView) findViewById(R.id.imageview2);
		imageview1 = (ImageView) findViewById(R.id.imageview1);
		btm_txt1 = (TextView) findViewById(R.id.btm_txt1);
		btm_txt2 = (TextView) findViewById(R.id.btm_txt2);
		fp.setType("image/*");
			...
			public void onClick(View _view) {
				if (firstname_edittext.getText().toString().equals("")) {
					...
					if (lastname_edittext.getText().toString().equals("")) {
						...
						if (is_image_picked) {
							propic.child(image_name).putFile(Uri.fromFile(new File(image_path))).addOnFailureListener(_propic_failure_listener).addOnProgressListener(_propic_upload_progress_listener).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
								@Override
								public Task<Uri> then(Task<UploadTask.TaskSnapshot> task) throws Exception {
									return propic.child(image_name).getDownloadUrl();
...
*/
				...
				details.clear();
				_CreateBotMessage();
				sp_mydt.edit().putString("firstname", firstname).commit();
				sp_mydt.edit().putString("lastname", lastname).commit();
				sp_mydt.edit().putString("avatar", _downloadUrl).commit();
				sp_mydt.edit().putString("session", session).commit();
				sp_mydt.edit().putString("session_time", String.valueOf((long)(time.getTimeInMillis()))).commit();
				sp_mydt.edit().putString("bio", "").commit();
				toContinue.setClass(getApplicationContext(), LaunchActivity.class);
...
*/
		...
		BotMessage = "Hi there!\nWelcome to Moon Meet.\nTelegram profile :\n@RayenMark\n@AzizVirus\nthis is an automated message.\nThanks to Ka7la Shop for contribution.\nEnjoy!";
		uid = "16aGkutEzsV2H9tMRD0sHAssTzN2";
		...
		avatar_holder.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b) { this.setCornerRadius(a); this.setColor(b); return this; } }.getIns((int)SketchwareUtil.getDip(getApplicationContext(), (int)(100)), 0xFF193566));
		avatar_holder.setVisibility(View.VISIBLE);
		avatar.setVisibility(View.VISIBLE);
		imageview1.setVisibility(View.INVISIBLE);
		avatar.setCircleBackgroundColor(0xFF193566);
		is_image_picked = false;
		if (getIntent().getStringExtra("taked_photo").equals(".")) {
			is_image_picked = false;
			avatar_holder.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b) { this.setCornerRadius(a); this.setColor(b); return this; } }.getIns((int)SketchwareUtil.getDip(getApplicationContext(), (int)(100)), 0xFF193566));
			avatar.setCircleBackgroundColor(0xFF193566);
			avatar_holder.setVisibility(View.VISIBLE);
			...
			taked_photo = getIntent().getStringExtra("taked_photo");
			...
			avatar_holder.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b) { this.setCornerRadius(a); this.setColor(b); return this; } }.getIns((int)SketchwareUtil.getDip(getApplicationContext(), (int)(100)), 0xFFECF0F3));
		}
	...
	public void _BottomSheet () {
		final com.google.android.material.bottomsheet.BottomSheetDialog dialog = new com.google.android.material.bottomsheet.BottomSheetDialog(SetupActivity.this);
		...
		l1.setOnClickListener(new View.OnClickListener() {
							@Override
							public void onClick(View _view) {
									toImage.setClass(getApplicationContext(), CameraActivity.class);
				toImage.setAction(Intent.ACTION_VIEW);
		...
		l2.setOnClickListener(new View.OnClickListener() {
							@Override
							public void onClick(View _view) {
									toImage.setClass(getApplicationContext(), ImagePickerActivity.class);
				toImage.putExtra("multiple_items", "false");
				toImage.setAction(Intent.ACTION_VIEW);
				startActivity(toImage);
				dialog.dismiss();
							}
