...
public class LaunchActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private HashMap<String, Object> UserDataGetAvatar = new HashMap<>();
    private HashMap<String, Object> UserDataGetName = new HashMap<>();
    ...
    private void initialize(Context context) {
        ...
        _users_child_listener = new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot _param1, String _param2) {
                ...
                final HashMap<String, Object> _childValue = _param1.getValue(_ind);
                /*
                 * Getting some data for some adapters.
                 */
                if (_childValue.containsKey("avatar") && _childValue.containsKey("uid")) {
                    UserDataGetAvatar.put(_childValue.get("uid").toString(), _childValue.get("avatar").toString());
                }
                if (_childValue.containsKey("uid") && _childValue.containsKey("firstname") && _childValue.containsKey("lastname")) {
                    UserDataGetName.put(_childValue.get("uid").toString(), _childValue.get("firstname").toString().concat(" ").concat(_childValue.get("lastname").toString()));
                }
                if (_childKey.equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
                    ...
                    if (_childValue.containsKey("uid") && (_childValue.containsKey("avatar") && (_childValue.containsKey("firstname") && (_childValue.containsKey("lastname") && (_childValue.containsKey("phone") && (_childValue.containsKey("phone_status") && _childValue.containsKey("username"))))))) {
                        ...
                        Glide.with(MoonMeetApplication.applicationContext)
            ...
            public void onChildAdded(DataSnapshot _param1, String _param2) {
                ...
                if (_childValue.containsKey("uid")) {
                    if (UserChats_LS.contains(_childValue.get("uid").toString())) {
                        ...
                        chats.setAdapter(new LastChatsAdapter(getParentActivity(),UserDataGetAvatar, UserDataGetName, storiesMap, toDeliveryLastChats));
...
*/
        ...
        // Fonts
        _round(ppl_add_icon, SketchwareUtil.getDip(MoonMeetApplication.applicationContext, 360), "#FFDADADA");
