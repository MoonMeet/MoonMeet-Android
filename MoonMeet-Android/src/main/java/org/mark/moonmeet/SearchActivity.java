...
public class SearchActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
                ...
                for (DataSnapshot _data : _param1.getChildren()) {
                    ...
                    if (_map.containsKey("uid")) {
                        if (UserChats_LS.contains(_map.get("uid").toString())) {
                            ...
                            chats_rv.setAdapter(new LastChatsAdapter(getParentActivity(),UserDataGetAvatar, UserDataGetName, storiesMap, UserChats_LM));
    ...
    private void initialize(Context context) {
        ...
        tab1_btn.setOnClickListener(_view -> {
        ...
        tab2_btn.setOnClickListener(_view -> {
            scroll.post(() -> scroll.fullScroll(scroll.FOCUS_UP));
            _autoScroll(150, tabsholder);
        ...
        tab3_btn.setOnClickListener(_view -> {
            scroll.post(() -> scroll.fullScroll(scroll.FOCUS_UP));
            _autoScroll(150, tabsholder);
            tab1.setVisibility(View.VISIBLE);
