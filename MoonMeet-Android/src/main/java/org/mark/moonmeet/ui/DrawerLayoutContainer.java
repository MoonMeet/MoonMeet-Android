...
import org.mark.moonmeet.messenger.Utilities;
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            setOnApplyWindowInsetsListener(new OnApplyWindowInsetsListener() {
                ...
                public WindowInsets onApplyWindowInsets(View v, WindowInsets insets) {
                    ...
                    firstLayout = false;
                    lastInsets = insets;
                    drawerLayoutContainer.setWillNotDraw(insets.getSystemWindowInsetTop() <= 0 && DrawerLayoutContainer.this.getBackground() == null);

                    if (Build.VERSION.SDK_INT >= 28) {
                        DisplayCutout cutout = insets.getDisplayCutout();
                        hasCutout = cutout != null && cutout.getBoundingRects().size() != 0;
                    }
                    DrawerLayoutContainer.this.invalidate();
